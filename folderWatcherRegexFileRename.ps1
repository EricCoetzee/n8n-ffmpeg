...
$action = {
    ...
    Write-Host "   Format: Grand Theft Auto @San Andreas@ #Trilogy# vehicle %<1>% !<2>! (<3>) .Garage. ,gtasa, _Los Santos_ -<4>-" -ForegroundColor Gray
    ...
    $newName = "Grand Theft Auto @San Andreas@ #Trilogy# vehicle %${clean1}% !${clean2}! (${clean3}) .Garage. ,gtasa, _Los Santos_ -${clean4}-.mp4"
